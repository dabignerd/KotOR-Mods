...
void main() {
	...
	ActionDoCommand(ApplyEffectToObject(0, EffectDamage(100), oEnd_jedi01, 0.0));
	DelayCommand(2.0, CancelCombat(oEnd_jedi01));
    DelayCommand(2.0, AssignCommand(oEnd_jedi01, ActionUnequipItem(GetObjectByTag("g_w_shortsbr02"), TRUE)));
	ActionWait(2.0);
	ActionDoCommand(ApplyEffectToObject(0, EffectHeal(24), oEnd_jedi01, 0.0));
	ActionDoCommand(SetMinOneHP(oEnd_jedi01, 0));
	DelayCommand(3.5, AssignCommand(oEnd_jedi01, SetFacingPoint(GetPosition(GetFirstPC()))));
	ChangeToStandardFaction(oEnd_jedi01, 1);
