  ...
  do {
    ...
    case 11:  //low level droid container
      ...
      */
      ...
      sTemplate = "G_I_DRDSNCSEN001";
      if(SWTR_InRange(iRoll,80,89) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
      }
      sTemplate = "G_I_DRDSRCSCP001";
      if(SWTR_InRange(iRoll,90,99) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
    ...
    case 12:  //mid level droid container
      ...
      */
      ...
      sTemplate = "G_I_DRDSNCSEN002";
      if(SWTR_InRange(iRoll,80,89) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
      }
      sTemplate = "G_I_DRDSRCSCP002";
      if(SWTR_InRange(iRoll,90,99) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
    ...
    /*
      ...
      */
      ...
      sTemplate = "G_I_DRDSNCSEN003";
      if(SWTR_InRange(iRoll,80,89) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
      }
      sTemplate = "G_I_DRDSRCSCP003";
      if(SWTR_InRange(iRoll,90,99) && SWTR_IsUnique(sTemplate,sFilter))
      {
        sObjDesc = sTemplate;
        bFound = TRUE;
