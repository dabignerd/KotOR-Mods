...
void main() {
	...
	if (((((GetGlobalNumber("Tar_ZelkaTk") == 2) && (GetGlobalNumber("Tar_RakSerum") != 1)) && GetIsPC(oEntering)) && (!sub1(OBJECT_SELF)))) {
		sub2(OBJECT_SELF, 1);
		sub3("gurney talking", 5, 5, 1.0);
		sub4("Gurney021", "", OBJECT_INVALID);
	}
}
