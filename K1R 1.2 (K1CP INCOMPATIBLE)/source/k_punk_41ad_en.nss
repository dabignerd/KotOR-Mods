...
void main() {
	...
	oEntering = GetEnteringObject();
       ...
       {
           if(GetGlobalNumber("UNK_PUZS_STATE") == 14) { ExecuteScript("k1r_unk_puzsdone", OBJECT_SELF); }
           if(GetGlobalNumber("UNK_PUZM_STATE") == 14) { ExecuteScript("k1r_unk_puzmdone", OBJECT_SELF); }
       }
